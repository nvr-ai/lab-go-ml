...
// 				Provider: CoreMLProviderBackend,
// 				Options: map[string]string{
// 					"use_cpu_only": "false",
// 				},
// 				Priority: 10,
...
// 		providers = append(providers, ExecutionProviderConfig{
// 			Provider: TensorRTProviderBackend,
// 			Options: map[string]string{
// 				"device_id":               "0",
...
// func (dso *DynamicShapeOptimizer) ObserveShape(inputName string, shape []int64, inferenceTimeMs
// float64) {
// 	dso.mu.Lock()
// 	defer dso.mu.Unlock()
...
// 			observations[i].AvgTimeMs = (observations[i].AvgTimeMs*float64(observations[i].Count-1) +
// inferenceTimeMs) /
// float64(observations[i].Count)
// 			found = true
// 			break
// 		}
// 	}
...
// 		if profile.InputName == inputName && shapeWithinBounds(shape, profile.MinShape,
// profile.MaxShape) {
