...
type ClassManager struct {
	sets map[OutputClassGeneration]*OutputClassSet
}

// NewClassManager initializes and registers the given sets.
func NewClassManager(allSets ...*OutputClassSet) *ClassManager {
	mgr := &ClassManager{sets: make(map[OutputClassGeneration]*OutputClassSet)}
...
func (m *ClassManager) GetName(style OutputClassGeneration, idx int) (string, error) {
	set, ok := m.sets[style]
	if !ok {
...
func (m *ClassManager) GetIndex(style OutputClassGeneration, name string) (int, error) {
	set, ok := m.sets[style]
	if !ok {
...
func (m *ClassManager) MapClass(fromStyle OutputClassGeneration, idx int, toStyle OutputClassGeneration) (OutputClass, error) {
...
func LookupName(style OutputClassGeneration, idx int) string {
